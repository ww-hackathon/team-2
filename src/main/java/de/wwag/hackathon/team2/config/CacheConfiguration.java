...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, de.wwag.hackathon.team2.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, de.wwag.hackathon.team2.repository.UserRepository.USERS_BY_EMAIL_CACHE);
            ...
            createCache(cm, de.wwag.hackathon.team2.domain.DailyReservation.class.getName());
